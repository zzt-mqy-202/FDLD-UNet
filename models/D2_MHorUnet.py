...
if __name__ == '__main__':
    ...
    net = MHorunet(num_classes=1, input_channels=3, layer_scale_init_value=1e-6, gnconv=gnconv, block=Block,
                 pretrained=None, use_checkpoint=False, c_list=[8, 16, 32, 64, 128, 256], depths=[2, 3, 18, 2], drop_path_rate=0.,
